...
echo "REDIS_HOSTS=redis01-master:173.17.0.10:6379:0:${PASSWORD},redis02-master:173.17.0.20:6379:0:${PASSWORD},redis03-master:173.17.0.30:6379:0:${PASSWORD},redis01-slave:173.17.0.40:6379:0:${PASSWORD},redis02-slave:173.17.0.50:6379:0:${PASSWORD},redis03-slave:173.17.0.60:6379:0:${PASSWORD}" > .env
...
if [[ $answer == "y" || $answer == "Y" ]]; then
    docker-compose up -d
    docker exec -it redis-master-1 redis-cli -a $PASSWORD --cluster create 173.17.0.10:6379 173.17.0.20:6379 173.17.0.30:6379 173.17.0.40:6379 173.17.0.50:6379 173.17.0.60:6379 --cluster-replicas 1
